...
const projects = [
  {
    ...
    technologies: ["Next.js", "TypeScript", "OpenCV", "FastAPI"],
  ...
  },
  {
    ...
    technologies: ["Next.js", "Supabase", "PostgreSQL", "Zod"],
    githubUrl: "https://github.com/22207018/kuvaneti-site",
    liveUrl: "#",
  },
  {
    title: "CPU Scheduler Simulator",
    description: "C++ implementation of 6 CPU scheduling algorithms with custom data structures.",
    problem: "Need for educational tool to visualize OS algorithms.",
    solution: "Implemented FCFS, SJF, Priority, RR with visualization.",
    outcome: "Educational tool used by 200+ students.",
    technologies: ["C++", "Data Structures", "Linux", "Make"],
    githubUrl: "https://github.com/CIU-Computer-Engineering/cpu-scheduler-simulator-2425f-Tech-beep1304",
  },
  {
  ...
  },
  {
    ...
    solution: "Optimized PID control algorithms and custom sensor placement.",
    outcome: "Competition-ready robot demonstrating robust performance.",
    technologies: ["Arduino", "PID Control", "Embedded C++"],
